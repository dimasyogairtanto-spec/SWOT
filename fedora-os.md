...
|---|---|---|---|
|**Binary compatible dengan RHEL** → stabil & konsisten|Kurang ramah untuk pemula karena **berbasis CLI**|Tersedia **image ISO & QCOW2** untuk instalasi fisik & virtual|Persaingan dengan distro sejenis (Rocky Linux, Oracle Linux)|
...
**SWOT SPAROW DAN FEDORA**

| **Strength** | **Weakness**              | **Opportunity** | **Threats**                              |
| ------------ | ------------------------- | --------------- | ---------------------------------------- |
| berbasis cli | dokumentasi mudah di cari |                 | belum banyak dokumentasi mengenai sparow |
|              |                           |                 |                                          |
|              |                           |                 |                                          |
